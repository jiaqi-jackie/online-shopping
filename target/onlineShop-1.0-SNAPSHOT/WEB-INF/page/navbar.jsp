...
<nav class="navbar navbar-inverse">
    <div  class="container-fluid">
        <div class="navbar">
            <img  style="float:left" src="<c:url value="/resource/images/logo.svg" />" width="210px" height="130px" alt="logo-image"/>
            <p style="color:white; font-size: 40px; margin-top: 30px; float:left">Shopping with us</p>
        </div>
